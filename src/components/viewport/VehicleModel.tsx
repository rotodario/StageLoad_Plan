import type { Truck, VehicleDisplaySettings, VehicleWeightAnalysis } from "../../types/loadplan";
...
export function VehicleModel({ truck, settings, analysis }: Props) {
  return (
    <group>
      ...
      {settings.showAxles && <AxleAssemblyModel truck={truck} mode={settings.mode} showWheels={settings.showWheels} />}
